...
def stratified_train_val_test_split(data, train_ratio=0.6, val_ratio=0.2, test_ratio=0.2, random_seed=42):
    """
    Create a stratified train/validation/test split that maintains class balance.
    ...
    train_idx_0 = int(len(class_0_data) * train_ratio)
    val_idx_0 = int(len(class_0_data) * (train_ratio + val_ratio))
    
    train_idx_1 = int(len(class_1_data) * train_ratio)
    val_idx_1 = int(len(class_1_data) * (train_ratio + val_ratio))
    
    # Split each class
    train_class_0 = class_0_data[:train_idx_0]
    val_class_0 = class_0_data[train_idx_0:val_idx_0]
    test_class_0 = class_0_data[val_idx_0:]
    
    train_class_1 = class_1_data[:train_idx_1]
    val_class_1 = class_1_data[train_idx_1:val_idx_1]
    test_class_1 = class_1_data[val_idx_1:]
